<script lang="ts">
  ...
  const projectInfo = {
    title: "UNO (Symfony) — Jeu de cartes",
    year: "2026",
    role: "Développement Web Full-Stack (Symfony / PHP)",
    technologies: ["Symfony", "PHP", "Twig", "CSS", "Sessions"],
    description:
      "Un jeu UNO développé avec Symfony, pensé pour structurer proprement la logique métier côté backend. Le projet repose sur une architecture MVC claire, avec gestion des cartes, des joueurs, des tours et de l’état global de la partie. J’ai également travaillé sur le déploiement en ligne via Railway pour rendre le projet accessible publiquement.",
    features: [
      "Architecture MVC avec Symfony",
      "Gestion de la logique de jeu (cartes, joueurs, tours)",
      "Organisation propre de la logique métier avec des modèles dédiés",
      "Déploiement en ligne sur Railway",
    ],
    challenges: [
      "Structurer un projet Symfony de jeu avec une séparation claire entre contrôleurs et logique métier",
      "Gérer l’état de la partie et l’enchaînement des tours côté backend",
      "Mettre en ligne l’application sur Railway et résoudre les problèmes de déploiement",
    ],
    results: [
      "Jeu UNO structuré avec Symfony",
      "Logique backend fonctionnelle et maintenable",
      "Projet déployé en ligne et prêt à être présenté dans le portfolio",
    ],
    links: {
      live: "https://unomaryline.up.railway.app",
      github: "https://github.com/marylineb/UNO_maryline",
    },
  };
...
<svelte:head>
  <title>UNO (Symfony) | Maryline BILOA</title>
  <meta
    name="description"
    content="Projet UNO développé avec Symfony : logique de jeu backend, architecture MVC et déploiement Railway."
  />
</svelte:head>
...
<main class="project-page">
  ...
  <section class="featured-image" bind:this={imageElements[0]}>
    <div class="image-frame">
      <img src="/img/captureuno.png" alt="UNO Symfony — écran principal" />
  ...
  <section class="gallery">
    <div class="gallery-item" bind:this={imageElements[5]}>
      <div class="gallery-frame">
        <img src="/img/captureunojeu.png" alt="UNO Symfony — vue principale" />
      </div>
      <p class="caption">
        <span class="caption-dot"></span>Vue du jeu en cours
      </p>
    </div>

    <div class="gallery-item" bind:this={imageElements[6]}>
      <div class="gallery-frame">
        <img src="/img/captureunowin.png" alt="UNO Symfony — aperçu secondaire" />
      </div>
      <p class="caption">
        <span class="caption-dot"></span>page "vous avez gagné🏅"
      </p>
    </div>
  </section>
